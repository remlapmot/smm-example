...
# gmm fit
tsrigmmlog1 <- gmm(tsriLogMultMoments, x = dat, t0 = c(coef(stage1), coef(stage2)), vcov = "iid")
...
# gmm fit
tsrigmmlog2 <- gmm(tsriLogAddMoments, x = dat, t0 = c(coef(stage1), coef(stage2)), vcov = "iid")
